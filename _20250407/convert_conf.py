...
def main(config_path):
    """Główna funkcja skryptu, która przyjmuje ścieżkę do configu."""
...
if __name__ == '__main__':
    ...
    # Dodajemy argument pozycyjny 'config_path'
    parser.add_argument("config_path", help="Ścieżka do pliku konfiguracyjnego spaCy (.cfg)")
    
    # Parsujemy argumenty podane przy uruchomieniu skryptu
    args = parser.parse_args()
    
    # Wywołujemy główną funkcję, przekazując jej ścieżkę z argumentu
